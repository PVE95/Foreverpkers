...
public final class EntityDef {
	...
	public static EntityDef forID(int i) {
		...
		switch(i) {
			case 3843:
				entityDef.name = "Ttarmek";
				entityDef.description = "A guardian troll of the Sea Troll Queen.".getBytes(); // NPC description
			break;
			case 3842:
				entityDef.name = "Mezilkree";
				entityDef.description = "A ranger guardian troll of the Sea Troll Queen.".getBytes(); // NPC description
			break;
			case 3841:
				entityDef.name = "Soliix";
				entityDef.description = "A magical guardian troll of the Sea Troll Queen.".getBytes(); // NPC description
			break;
		}
	...
	if(i == 3066) { // NPC ID 
    entityDef.name = "@or2@Zombie champion"; // NPC name
    entityDef.combatLevel = 255; //combat level
    entityDef.description = "I can smell the stench of the dead warriors that have been devoured here..".getBytes(); // NPC description
	}
	if(i == 2551) { // NPC ID 
    entityDef.actions = new String[5];
    entityDef.actions[1] = "Attack";
