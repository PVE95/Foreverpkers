...
public class ModelDecompressor {
	...
	public static void loadModels() {
		try {
			DataInputStream indexFile = new DataInputStream(new FileInputStream(signlink.findcachedir()+"models.idx")); //Example C:/my client/models/1.dat
			DataInputStream dataFile = new DataInputStream(new FileInputStream(signlink.findcachedir()+"models.dat")); //Example C:/my client/models/1.idx
