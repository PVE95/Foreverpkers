...
public final class RSInterface {
	...
	public static void friendsTab(TextDrawingArea[] tda) {
        ...
        tab.child(1, 16127, 4, 25);
        tab.child(2, 16126, 4, 221);
        tab.child(3, 5066, 4, 24);
        tab.child(4, 16126, 4, 22);
	...
	public static void clanChatTab(TextDrawingArea[] tda) {
        ...
        tab.child(0, 16126, 4, 221);
        tab.child(1, 16126, 4, 59);
        tab.child(2, 18137, 4, 62);
        tab.child(3, 18143, 4, 62);
...
private static Sprite LoadSprite(int i, String s) {
        ...
        try {
            sprite = new Sprite("C:/.ForeverPkers_Cache/Sprites/"+s+" "+i+".PNG");
            aMRUNodes_238.removeFromCache(sprite, l);
        } catch (Exception exception) {
