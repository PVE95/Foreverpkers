...
public class ItemReplace {
	...
	/*public int toReplace = 11728;
	public int altRemove = 11729;
	public int replaceWith = 2365;
	public int altReplace = 2366;
	public int replaceAmount = 50;*/
	public int toReplace = 10362;
	public int altRemove = 10363;
	public int replaceWith = 2365;
	public int altReplace = 2366;
	public int replaceAmount = 50;
					...
					if (temp.split("\t").length > 2) {
						if (temp.contains("item") || temp.contains("bank")) {
							...
							if (Integer.parseInt(items[1]) == altRemove) {
								items[1] = "" + altReplace;
								items[2] = "" + Integer.parseInt(items[2])*replaceAmount;
							}
							temp = items[0] + "\t" + items[1] + "\t" + items[2];
						} else if (temp.contains("character-equip")) {
							String[] items = temp.split("\t");
