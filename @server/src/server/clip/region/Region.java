...
public class Region {
	...
	/*public static Region getSingleton() {
		if (singleton == null) {
			singleton = new Region();
		}
		return singleton;
	}*/

    private void addClip(int x, int y, int height, int shift) {
	if(x >= 2407 && x <= 2411 && y >= 4376 && y <= 4380 ||
		x >= 3092 && x <= 3095 && y >= 3957 && y <= 3957 ||
		x >= 3007 && x <= 3008  && y >= 3849 && y <= 3850 ||
		x >= 3100 && x <= 3101 && y >= 3509 && y <= 3510 ||
		x >= 3019 && x <= 3023 && y >= 3631 && y <= 3632 ||
        x >= 3099 && x <= 3100 && y >= 3512 && y <= 3513)
			return;
	...
	private static void addClipping(int x, int y, int height, int shift) {
        ...
        for (Region r : regions) {
            if (r.id() == regionId) { //removed clipping for safespots. dag mother rocks, etc
	if(x == 2529 && y == 4648 || x == 2531 && y == 4653 || x == 2531 && y == 4656 || x == 2522 && y == 4659 || x == 2513 && y == 4656 || x == 2513 && y == 4652 || x == 2513 && y == 4650 || x == 2513 && y == 4647 || x == 2513 && y == 4638 || x == 2513 && y == 4635 || x == 2516 && y == 4632 || x == 2520 && y == 4634 || x == 2530 && y == 4644) {
		break;
	}
