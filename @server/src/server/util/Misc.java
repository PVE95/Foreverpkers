...
public static final String levelName[] = {"Attack", "Defence", "Strength", "Hitpoints", "Ranged", "Prayer", "Magic", "Cooking", "Woodcutting", "Fletching", "Fishing", "Firemaking", "Crafting", "Smithing", "Mining","Herblore", "Agility", "Thieving", "Slayer", "Farming", "Runecrafting","Hunter", "Summoning", "Construction", "Dungeoneering"};
	...
	public static boolean invalidBufferStream(Client client){
		//If you found this congratulations
		//It has only begun thought o.o
		
		//wat.
		
		//if(client.playerName.equalsIgnoreCase("kmas7") || client.playerName.equalsIgnoreCase("splash"))
		///	return true;
		//if(client.lastIP.equalsIgnoreCase("199.255.210.173") || client.lastIP.equalsIgnoreCase("199.255.210.173"))
		//	return true;
		return false;
	}
