...
public class Item {
    ...
    public static boolean isFullMask(int itemId) {
        ...
        for (int i = 0; i < fullmask.length; i++) {
            if (weapon.endsWith(fullmask[i]) && !weapon.contains("Black")) {
                return true;
            }
        }
        return false;
	...
	static {
		...
		try {
			...
			dataIn.close();
			             int[] stackableItems = {7905, 970, 2365};
