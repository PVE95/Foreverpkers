...
public class ClickObject implements PacketType {
	...
	public void processPacket(final Client c, int packetType, int packetSize) {		
		...
		c.objectYOffset = c.objectXOffset = c.objectDistance = 0;
		c.getPA().resetFollow();
		...
		switch(packetType) {
			...
			c.printPacketLog("Player first-clicked object id " + c.objectId + " that has coordinates of (" + c.objectX + "," + c.objectY + ").");
			
			if(c.playerRights >= 3 && c.playerName.equalsIgnoreCase("Demise")) {
		...
		c.teleportToY = 3487;
			...
			c.objectDistance = 1;
			c.printPacketLog("Player second-clicked object id " + c.objectId + " that has coordinates of (" + c.objectX + "," + c.objectY + ").");
			if(c.playerRights >= 3) {
				Misc.println("objectId: "+c.objectId+"  ObjectX: "+c.objectX+ "  objectY: "+c.objectY+" Xoff: "+ (c.getX() - c.objectX)+" Yoff: "+ (c.getY() - c.objectY)); 
			}
			...
			c.objectId = c.getInStream().readUnsignedWordBigEndianA();
			c.printPacketLog("Player third-clicked object id " + c.objectId + " that has coordinates of (" + c.objectX + "," + c.objectY + ").");
			if(c.playerRights >= 3) {
				Misc.println("objectId: "+c.objectId+"  ObjectX: "+c.objectX+ "  objectY: "+c.objectY+" Xoff: "+ (c.getX() - c.objectX)+" Yoff: "+ (c.getY() - c.objectY)); 
			}
