...
//do not block stupid non offensive words or accidental types - ass, damn, etc.
    ...
    public static int PK[] = {7462, 6731, 6733, 6735, 6737, 10551, 10548, 8850, 11732};
        ...
        public static int DPresent4[] = { 11724, 11726, 13744, 13738,3748, 3758, 11284, 13742 }; // pretty good
       
        public static int DPresent5[] = { 8921,11694,14484,3758,4212,13045,13263,13022, 13887, 13893 }; // rare

        public static int DPresent6[] = { 13399, 13740, 15662, 15574, 18391 }; // mega rare

        public static int DPresent7[] = { 19780 }; // special
		...
		public static int ShinyChestItems2[] = { 19114, 15126, 7462, 15220, 15018, 15019, 15020, 4224,4212,10330,10332,10334,10336,10338,10340,10342,10344,10346,10348,10350,10352,12422,12424, };
		
		public static int MagicChestItems[] = { 13876,13864,13896,13861,13858,13902,13899,13890,13884,13893,13887,13873,13870 };
...
public static int DonatorItems[] = { 1547, 6542 };
...
getPA().sendFrame126(" ", 8617);*/
	...
	if(brightness == 4) {
		...
		getPA().sendFrame36(166, 4);
			...
			sendMessage("");
			sendMessage("");
			sendMessage("Welcome back to ForeverPkers! There are @blu@"+(PlayerHandler.getPlayerCount())+ " @bla@players online.");
			...
			sendMessage("Visit our website at @blu@www.Forever-Pkers.com@bla@!");
			sendMessage("Economy started on @blu@May 2nd, 2018@bla@");

			getPA().writePlayers(""+PlayerHandler.getPlayerCount());
		...
		int thisReset = 54; //Number of this reset. Skipped: 5
		...
		if(gotShit < thisReset){
			...
			pkPoints = (int) (KC * 25 * membBonus); 		//PK Points Kills * 5 * Member bonus (5-15%)
			//pkPoints = 0;
