...
public class SkillGuides {
	...
	public static void skillsInterface(Client client, String skill, 
					...
					int item9ItemId, int item9lvl, String item9lvldef) {
		...
		item[7] = item8ItemId;
		item[8] = item9ItemId;
		client.getPA().sendFrame126("",8720);
		client.getPA().sendFrame126("",8721);
		client.getPA().sendFrame126("",8722);
		client.getPA().sendFrame126("",8723);
		client.getPA().sendFrame126("",8724);
		client.getPA().sendFrame126("",8725);
		client.getPA().sendFrame126("",8726);
		client.getPA().sendFrame126("",8727);
		client.getPA().sendFrame126("",8728);
		client.getPA().sendFrame126("",8729);
		client.getPA().sendFrame126("",8730);
		if(item1lvl > 0)
		...
		if(item9lvl > 0)
		client.getPA().sendFrame126(""+item9lvl,8728);
		client.getPA().sendFrame126(""+item9lvldef, 8768);
	...
	public static void skillsInterface(Client client, String skill, 
		...
		client.getPA().sendFrame126(""+item8lvldef, 8767);
		client.getPA().sendFrame126("",8728);
		client.getPA().sendFrame126("", 8768);
		client.getPA().sendFrame126("",8849);
		client.getPA().sendFrame126("Attack",8846);
		client.getPA().sendFrame126("Strength",8823);
		client.getPA().sendFrame126("Defence",8824);
	...
	public static void thievingInterface(Client client) {
		skillsInterface(client, "Thieving", 
					995, 1, "Crafting Stall", 
					995, 25, "Food Stall", 
					995, 50, "General Stall", 
					995, 75, "Magic Stall", 
					995, 90, "Scimitar Stall", 
					995, 1, "Wilderness Chest",
					0, 0, "",
					0, 0, "");
	}
	...
	public static void slayerInterface(Client client) {
		skillsInterface(client, "Slayer", 
					4447, 1, "1% bonus drop rate per level", 
					4140, 45, "Infernal mages", 
					4142, 52, "Jellies", 
					4145, 65, "Dustdevils",
					4147, 75, "Gargoyles", 
					4148, 80, "Nechryaels",
					4149, 85, "Abyssal demons",
					0, 90, "Dark beasts",
					4447, 99, "1% bonus drop rate per million experience"
					);
	}
