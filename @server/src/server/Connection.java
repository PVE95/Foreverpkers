...
public class Connection {
	...
	public static ArrayList <String>starterRecievedNames = new ArrayList<String> ();
	...
	public static void appendStartersNames() {
		try {
			BufferedReader in = new BufferedReader(new FileReader("./Data/starters/NamesStarterRecieved.txt"));
			String data = null;
			try {
				while ((data = in.readLine()) != null) {
					starterRecievedNames.add(data);
				}
			} finally {
				in.close();
			}
    ...
    public static void coordinates(String COORDS) {
		addCoord(COORDS);
	}
	...
	public static void addIpToStarterNames(String name) {
		starterRecievedNames.add(name);
		addIpToStarterListNames(name);
		}
	public static void addCoord(String COORDS) {
		try {
			BufferedWriter out = new BufferedWriter(new FileWriter("./Data/list.txt", true));
		    try {
				out.newLine();
				out.write(COORDS);
		    } finally {
	...
	public static void addIpToStarterListNames(String Name) {
		try {
			BufferedWriter out = new BufferedWriter(new FileWriter("./Data/starters/NamesStarterRecieved.txt", true));
		    try {
				out.newLine();
				out.write(Name);
		    } finally {
	...
	public static boolean hasRecievedStarterName(String name) {
		if(starterRecievedNames.contains(name)) {
			return true;
		}
		return false;
	}
	...
	**/
	...
	public static void addNameToHostban(String Name) {
		try {
			BufferedWriter out = new BufferedWriter(new FileWriter("./Data/bans/blacklist.txt", true));
		    try {
				out.newLine();
				out.write(Name);
		    } finally {
